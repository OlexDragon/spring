...
//		new RestServiceConsumer (new AdsIndeedCom(), keywords, location, page, pagesize);
	...
	public String searchResult(
		...
		JSONObject searchResult = getSearchResult(keywords, location, null, null, response);
	...
	private JSONObject getSearchResult(String keywords, String location, Integer page, Integer pagesize, HttpServletResponse response) {
		logger.entry(keywords, location, page, pagesize);
