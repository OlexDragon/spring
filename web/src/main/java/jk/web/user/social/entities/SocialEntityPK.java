...
package jk.web.user.social.entities;
...
public class SocialEntityPK implements Serializable {
    ...
    public SocialEntityPK() {
    }

    public SocialEntityPK(String userId, String providerId, String providerUserId) {
        this.userId = userId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SocialEntityPK)) {
            return false;
        }
        SocialEntityPK other = (SocialEntityPK) object;
    ...
    public String toString() {
        return "jk.web.SocialEntityPK[ userId=" + userId + ", providerId=" + providerId + ", providerUserId=" + providerUserId + " ]";
    }
